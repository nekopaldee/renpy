...
translate thai strings:
    ...
    new "## The init offset statement causes the initialization statements in this file to run before init statements in any other file."
    ...
    new "## The horizontal alignment of the button text. (0.0 is left, 0.5 is center, 1.0 is right)."
    ...
    new "## The position of the main menu text."
    ...
    new "## This controls where a line break is permitted. The default is suitable for most languages. A list of available values can be found at https://www.renpy.org/doc/html/style_properties.html#style-property-language"
    ...
    new "## Change the size and spacing of various things."
