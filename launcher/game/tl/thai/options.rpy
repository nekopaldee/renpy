...
translate thai strings:
    ...
    new "## Text that is placed on the game's about screen. Place the text between the triple-quotes, and leave a blank line between paragraphs."
    ...
    new "## Between screens of the game menu."
